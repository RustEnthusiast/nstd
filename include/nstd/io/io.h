...
/// A result type that yields an [`NSTDUInt`] representing the number of bytes read or written by
/// an I/O operation on success and an I/O operation error code on failure.
